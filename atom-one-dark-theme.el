...
(defvar atom-one-dark-colors-alist
  (let* ((256color  (eq (display-color-cells (selected-frame)) 256))
         (colors `(("atom-one-dark-accent"   . "#528BFF")
                   ...
                   ("atom-one-dark-fg"       . (if ,256color "color-248" "#DCDFE4"))
...
(atom-one-dark-with-color-variables
  (custom-theme-set-faces
   ...
   `(gnus-summary-normal-read ((,class (:foreground ,atom-one-dark-gray :weight normal))))
   ...
   `(gnus-summary-low-unread ((,class (:foreground ,atom-one-dark-gray :weight normal))))
   `(gnus-summary-low-read ((,class (:foreground ,atom-one-dark-gray :weight normal))))
   `(gnus-summary-low-ancient ((,class (:foreground ,atom-one-dark-gray :weight normal))))
   ...
   `(gnus-group-mail-low ((,class (:foreground ,atom-one-dark-gray))))
   `(gnus-group-mail-low-empty ((,class (:foreground ,atom-one-dark-gray))))
   ...
   `(gnus-group-mail-1-empty ((,class (:inherit gnus-group-mail-1 :foreground ,atom-one-dark-gray))))
   `(gnus-group-mail-2-empty ((,class (:inherit gnus-group-mail-2 :foreground ,atom-one-dark-gray))))
   `(gnus-group-mail-3-empty ((,class (:inherit gnus-group-mail-3 :foreground ,atom-one-dark-gray))))
   `(gnus-group-mail-4-empty ((,class (:inherit gnus-group-mail-4 :foreground ,atom-one-dark-gray))))
   `(gnus-group-mail-5-empty ((,class (:inherit gnus-group-mail-5 :foreground ,atom-one-dark-gray))))
   `(gnus-group-mail-6-empty ((,class (:inherit gnus-group-mail-6 :foreground ,atom-one-dark-gray))))
   ...
   `(gnus-group-news-1-empty ((,class (:inherit gnus-group-news-1 :foreground ,atom-one-dark-gray))))
   `(gnus-group-news-2-empty ((,class (:inherit gnus-group-news-2 :foreground ,atom-one-dark-gray))))
   `(gnus-group-news-3-empty ((,class (:inherit gnus-group-news-3 :foreground ,atom-one-dark-gray))))
   `(gnus-group-news-4-empty ((,class (:inherit gnus-group-news-4 :foreground ,atom-one-dark-gray))))
   `(gnus-group-news-5-empty ((,class (:inherit gnus-group-news-5 :foreground ,atom-one-dark-gray))))
   `(gnus-group-news-6-empty ((,class (:inherit gnus-group-news-6 :foreground ,atom-one-dark-gray))))
