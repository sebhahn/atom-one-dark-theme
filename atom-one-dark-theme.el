...
hex values.  FRAME defaults to the selected frame."
  (let ((256color (eq (display-color-cells (or frame (selected-frame))) 256)))
    `(("atom-one-dark-accent"        . "#528BFF")
      ...
      ("atom-one-dark-mono-1"        . ,(if 256color "color-248" "#DCDFE4"))
...
(atom-one-dark-with-color-variables
  (custom-theme-set-faces
   ...
   `(company-tooltip-scrollbar-thumb ((t (:background ,atom-one-dark-mono-1))))
   `(company-tooltip-scrollbar-track ((t (:background ,atom-one-dark-bg-1))))
   ...
   `(diff-hl-change ((t (:foreground ,atom-one-dark-orange-1 :background "#684d33"))))
   `(diff-hl-delete ((t (:foreground ,atom-one-dark-red-1 :background "#70363a"))))
   `(diff-hl-insert ((t (:foreground ,atom-one-dark-green :background "#4c623c"))))
   ...
   `(ediff-even-diff-Ancestor                ((t (:background ,atom-one-dark-border))))
   `(ediff-even-diff-A                       ((t (:background ,atom-one-dark-border))))
   `(ediff-even-diff-B                       ((t (:background ,atom-one-dark-border))))
   `(ediff-even-diff-C                       ((t (:background ,atom-one-dark-border))))
   `(ediff-odd-diff-Ancestor                 ((t (:background ,atom-one-dark-border))))
   `(ediff-odd-diff-A                        ((t (:background ,atom-one-dark-border))))
   `(ediff-odd-diff-B                        ((t (:background ,atom-one-dark-border))))
   `(ediff-odd-diff-C                        ((t (:background ,atom-one-dark-border))))
   ...
   `(org-level-9 ((t (:foreground ,atom-one-dark-mono-3 ))))
   ...
   ;; mu4e
   `(mu4e-header-face ((,class (:foreground ,atom-one-dark-fg :inherit nil))))
   `(mu4e-header-highlight-face ((,class (:underline nil :inherit region :background ,atom-one-dark-gray))))
   `(mu4e-header-marks-face ((,class (:underline nil :foreground ,atom-one-dark-orange-2))))
   ...
   `(mu4e-ok-face ((,class (:foreground ,atom-one-dark-green))))
   `(mu4e-view-contact-face ((,class (:inherit nil :foreground ,atom-one-dark-orange-1))))
   `(mu4e-view-link-face ((,class (:inherit link :foreground ,atom-one-dark-blue))))
   `(mu4e-view-url-number-face ((,class (:inherit nil :foreground ,atom-one-dark-purple))))
   `(mu4e-view-attach-number-face ((,class (:inherit nil :foreground ,atom-one-dark-orange-1))))
   `(mu4e-highlight-face ((,class (:inherit highlight))))
   `(mu4e-title-face ((,class (:inherit nil :foreground ,atom-one-dark-green))))
   ...
   `(gnus-header-content ((t (:foreground ,atom-one-dark-fg))))
   `(gnus-header-subject ((,class (:inherit message-header-subject))))
   `(gnus-header-from ((,class (:inherit message-header-other-face :weight bold :foreground ,atom-one-dark-orange-1))))
   `(gnus-header-name ((,class (:inherit message-header-name))))
   `(gnus-button ((,class (:inherit link :foreground unspecified))))
   `(gnus-signature ((,class (:inherit font-lock-comment-face))))

   `(gnus-summary-normal-unread ((,class (:foreground ,atom-one-dark-fg :weight bold))))
   `(gnus-summary-normal-read ((,class (:foreground ,atom-one-dark-mono-3 :weight normal))))
   `(gnus-summary-normal-ancient ((,class (:foreground ,atom-one-dark-purple :weight normal))))
   `(gnus-summary-normal-ticked ((,class (:foreground ,atom-one-dark-orange-1 :weight normal))))
   `(gnus-summary-low-unread ((,class (:foreground ,atom-one-dark-mono-3 :weight normal))))
   `(gnus-summary-low-read ((,class (:foreground ,atom-one-dark-mono-3 :weight normal))))
   `(gnus-summary-low-ancient ((,class (:foreground ,atom-one-dark-mono-3 :weight normal))))
   `(gnus-summary-high-unread ((,class (:foreground ,atom-one-dark-orange-2 :weight normal))))
   `(gnus-summary-high-read ((,class (:foreground ,atom-one-dark-green :weight normal))))
   `(gnus-summary-high-ancient ((,class (:foreground ,atom-one-dark-green :weight normal))))
   `(gnus-summary-high-ticked ((,class (:foreground ,atom-one-dark-orange-1 :weight normal))))
   `(gnus-summary-cancelled ((,class (:foreground ,atom-one-dark-red-1 :background unspecified :weight normal))))

   `(gnus-group-mail-low ((,class (:foreground ,atom-one-dark-mono-3))))
   `(gnus-group-mail-low-empty ((,class (:foreground ,atom-one-dark-mono-3))))
   ...
   `(gnus-group-mail-1-empty ((,class (:inherit gnus-group-mail-1 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-mail-2-empty ((,class (:inherit gnus-group-mail-2 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-mail-3-empty ((,class (:inherit gnus-group-mail-3 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-mail-4-empty ((,class (:inherit gnus-group-mail-4 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-mail-5-empty ((,class (:inherit gnus-group-mail-5 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-mail-6-empty ((,class (:inherit gnus-group-mail-6 :foreground ,atom-one-dark-mono-3))))
   ...
   `(gnus-group-news-1-empty ((,class (:inherit gnus-group-news-1 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-news-2-empty ((,class (:inherit gnus-group-news-2 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-news-3-empty ((,class (:inherit gnus-group-news-3 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-news-4-empty ((,class (:inherit gnus-group-news-4 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-news-5-empty ((,class (:inherit gnus-group-news-5 :foreground ,atom-one-dark-mono-3))))
   `(gnus-group-news-6-empty ((,class (:inherit gnus-group-news-6 :foreground ,atom-one-dark-mono-3))))
   ...
   ;; ansi-color (Emacs >=28, replaces ansi-color-names-vector)
   `(ansi-color-black          ((t (:foreground ,atom-one-dark-black :background ,atom-one-dark-black))))
   `(ansi-color-red            ((t (:foreground ,atom-one-dark-red-1 :background ,atom-one-dark-red-1))))
   `(ansi-color-green          ((t (:foreground ,atom-one-dark-green :background ,atom-one-dark-green))))
   `(ansi-color-yellow         ((t (:foreground ,atom-one-dark-orange-2 :background ,atom-one-dark-orange-2))))
   `(ansi-color-blue           ((t (:foreground ,atom-one-dark-blue :background ,atom-one-dark-blue))))
   `(ansi-color-magenta        ((t (:foreground ,atom-one-dark-purple :background ,atom-one-dark-purple))))
   `(ansi-color-cyan           ((t (:foreground ,atom-one-dark-cyan :background ,atom-one-dark-cyan))))
   `(ansi-color-white          ((t (:foreground ,atom-one-dark-fg :background ,atom-one-dark-fg))))
   `(ansi-color-bright-black   ((t (:foreground ,atom-one-dark-mono-3 :background ,atom-one-dark-mono-3))))
   `(ansi-color-bright-red     ((t (:foreground ,atom-one-dark-red-1 :background ,atom-one-dark-red-1))))
   `(ansi-color-bright-green   ((t (:foreground ,atom-one-dark-green :background ,atom-one-dark-green))))
   `(ansi-color-bright-yellow  ((t (:foreground ,atom-one-dark-orange-2 :background ,atom-one-dark-orange-2))))
   `(ansi-color-bright-blue    ((t (:foreground ,atom-one-dark-blue :background ,atom-one-dark-blue))))
   `(ansi-color-bright-magenta ((t (:foreground ,atom-one-dark-purple :background ,atom-one-dark-purple))))
   `(ansi-color-bright-cyan    ((t (:foreground ,atom-one-dark-cyan :background ,atom-one-dark-cyan))))
   `(ansi-color-bright-white   ((t (:foreground ,atom-one-dark-mono-1 :background ,atom-one-dark-mono-1))))
...
non-nil or this command was called interactively."
  ...
  (when (and (memq 'atom-one-dark custom-enabled-themes)
             (or atom-one-dark-theme-force-faces-for-mode (called-interactively-p 'interactive)))
    (atom-one-dark-with-color-variables
      (cond
